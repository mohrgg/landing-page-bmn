            ...
            <div className="container-custom">
                <RevealOnScroll>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        {/* Featured Article */}
                        {featuredNews && (
                            <Link href={`/berita/${featuredNews.id}`} className="block bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-200 hover:shadow-xl transition-all group">
                                <motion.article
                                    whileHover={{ y: -5 }}
                                >
